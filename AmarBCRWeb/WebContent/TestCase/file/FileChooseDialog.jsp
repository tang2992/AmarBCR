...
<body bgcolor="#D3D3D3">
<form name="SelectFile" method="post" ENCTYPE="multipart/form-data" action="<%=sWebRootPath%>/TestCase/file/LoadExcelFile.jsp?CompClientID=<%=CurComp.getClientID()%>">
<table>
	<tr><td class="black9pt"  align="left"><font size="2">请选择一个文件作为附件上传:</font></td></tr>
   	<tr><td><input type="file" size=60  name="LoadFileName"></td></tr>
   	<tr><td><input type=hidden name="FileName" value="" ></td></tr>
   	<tr>
     	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
