...
<script type="text/javascript">
	setDialogTitle("对象关联配置");
	function newRecord(){
        OpenPage("/AppConfig/ObjectManage/ObjectTypeRelaInfo.jsp?ObjectType=<%=sObjectType%>","frameright","");  
	}
	...
	function mySelectRow(){
		...
		if(typeof(sRelationShip)=="undefined" || sRelationShip.length==0){
			OpenPage("/AppMain/Blank.jsp","frameright");
	      	...
	      	OpenPage("/AppConfig/ObjectManage/ObjectTypeRelaInfo.jsp?ObjectType=<%=sObjectType%>&RelationShip="+sRelationShip,"frameright"); 
		}
	}
