...
<body>
<iframe name="MyAtt" src="<%=com.amarsoft.awe.util.Escape.getBlankHtml(sWebRootPath)%>"  width=100% height=100% frameborder=0 hspace=0 vspace=0 marginwidth=0 marginheight=0 scrolling="no"> </iframe>
</body>
<%
	String sFile = java.net.URLDecoder.decode(CurPage.getParameter("file"),"UTF-8"); //ÎÄ¼þÃû
