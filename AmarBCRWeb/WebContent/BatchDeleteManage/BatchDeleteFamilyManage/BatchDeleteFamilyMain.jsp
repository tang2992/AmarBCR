<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "家族成员批量删除"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;家族成员批量删除&nbsp;&nbsp;"; //默认的内容区标题
	String PG_CONTNET_TEXT = "家族成员批量删除";//默认的内容区文字
	String PG_LEFT_WIDTH = "200";//默认的treeview宽度

	//获得页面参数

	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"家族成员批量删除","right");
	tviTemp.TriggerClickEvent=true; //是否选中时自动触发TreeViewOnClick()函数

	 //定义树图结构
	String sFolder1=tviTemp.insertFolder("root","家族成员批量删除","",1);
...
<script type="text/javascript"> 
	function TreeViewOnClick(){
		...
		if(sCurItemname=='未上报批量删除'){
			...
			AsControl.OpenView("/BatchDeleteManage/BatchDeleteFamilyManage/FamilyDeleteList.jsp","node=NotReport","right");
		}else{
			return;
		}
