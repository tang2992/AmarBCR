...
<table border="0"  cellspacing="0" cellpadding="0" id=InfoTable height="100%" width="100%">
	...
	<tr id="DWTR">
	    <td id="InfoDWArea" class="InfoDWArea">
			<iframe name="myiframe0" src="<%=com.amarsoft.awe.util.Escape.getBlankHtml(sWebRootPath)%>" marginwidth="0" marginheight="0" width=100% height=100% frameborder=0></iframe>			 
	    </td>
	</tr>
<%
