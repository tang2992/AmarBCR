...
<table <%=sTableStyle%>>
	<tr><td valign='top' colspan=2 class='tabhead' <%=sTabHeadStyle%>><%=sTabHeadText%></td></tr>
	<tr>
	...
	<tr>
		<td class='tabcontent' align='center' valign='top' colspan=2>
			<table cellspacing=0 cellpadding=0 style="border: 0;width: 100%;height: 100%;">
				...
				<tr id="mydown"> 
					<td>
					<div id=divDrag title='可拖拽改变窗口大小' ondrag="dragFrame(event);"><span class="imgsDrag" style="display:inline-block;">&nbsp;</span></div>
