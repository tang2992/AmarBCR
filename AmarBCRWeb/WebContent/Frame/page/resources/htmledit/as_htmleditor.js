...
function editor_updateOutput(objname) {
  ...
  // 特殊字符转换，具体在ParameterUtil.java有处理
  document.all[objname].value = contents.replace(/\&/g, "&#38;").replace(/\(/g, "&#40;").replace(/\)/g, "&#41;").replace(/\</g, "&#60;").replace(/\>/g, "&#62;").replace(/\+/g, "&#43;");
