...
<script type="text/javascript">
	...
	<%
		...
		if("0110".equals(sStatus)){//公司客户
			sWhereClause=" from BUSINESS_TYPE where TypeNo not like '3%' and TypeNo not like '2100%' and TypeNo not like '2060%' and TypeNo not like '2030_%' and TypeNo not like '2040_%' and Attribute1 like '%1%'";
		}else{//中小企业客户
			sWhereClause=" from BUSINESS_TYPE where TypeNo not like '3%' and TypeNo not like '2100%' and TypeNo not like '2060%' and TypeNo not like '2030_%' and TypeNo not like '2040_%' and Attribute1 like '%1%'";
		}
...
<tr height=4%>
	...
	<td nowrap align="right" class="black9pt" >
		<%=new Button("确定","确定","newBusiness()","","").getHtmlText()%>
	</td>
	<td nowrap class="black9pt" >
		<%=new Button("取消","取消","goBack()","","").getHtmlText()%>
	</td>
</tr>
</table>
</form>
