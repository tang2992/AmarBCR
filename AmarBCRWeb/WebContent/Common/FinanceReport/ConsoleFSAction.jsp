...
<%
	...
	sReportDate = CurPage.getParameter("ReportDate");
	sReportScope = CurPage.getParameter("ReportScope");
	sWhere = CurPage.getParameter("Where");
	sNewReportDate = CurPage.getParameter("NewReportDate");
	//报表操作类型
	sActionType = CurPage.getParameter("ActionType");
	//将空值转化为空字符串
