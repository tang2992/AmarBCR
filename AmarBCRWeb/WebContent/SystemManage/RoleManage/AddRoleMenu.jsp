			...
			<table width="100%">
				<tr>
					...
					<td width="30%" align="left">
						<%=new Button("&nbsp;取&nbsp;消&nbsp;","取消","javascript:self.returnValue='_none_';self.close();","","").getHtmlText()%>
					</td>
				</tr>
			</table>
		</td>
...
<script language="JavaScript">
   ...
   function pushButton(buttonName,push) 
	...
	function doQuery()
	{
		...
		PopPage("/SystemManage/RoleManage/AddMenuAction.jsp?RoleID=<%=sRoleID%>&ItemNo="+vReturn,"","dialogWidth=20px;dialogHeight=20px;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
		self.close();
	}
