...
<%@ include file="/Frame/resources/include/include_begin_list.jspf"%>
	...
	<%
	String PG_TITLE = "校验错误(有上报记录)信息列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
...
<%	
	...
	String where = "1=1 and exists (select 1 from jbo.bcr.HIS_GUARANTEEINFO HG where O.mainbusinessno=HG.gbusinessno)" ;
