...
<%@ include file="/IncludeBegin.jsp"%>
	...
	<%
	String PG_TITLE = "业务信息查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;业务信息查询&nbsp;&nbsp;"; //默认的内容区标题
	...
	<%
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"业务信息查询","right");
	...
	function TreeViewOnClick()
	{
		...
		if(typeof(sTableName)!="undefined"&&sTableName.length!=0&&sCurItemname!="业务信息维护"){
			OpenComp("BusinessQueryList","/DataMaintain/BusinessMaintain/BusinessManageList.jsp","IsQuery=true&TableName="+sTableName,"right");
		}else{
			return;							
		}
