...
public class Message
{
		...
		throws ECRException
	{
		...
		if (attribute == null)
			throw new ECRException((new StringBuilder("No type   definition or error in message's attributes  @message type:")).append(message.getType()).toString());
		try
		{
		...
		{
			ARE.getLog().debug(e);
			throw new ECRException((new StringBuilder("No type   definition or error in message's attributes  @message type:")).append(message.getType()).toString(), e);
		}
		attribute = xMessage.getAttribute("name");
		if (attribute == null)
			throw new ECRException((new StringBuilder("No name   definition  or error in message's attributes  @message type:")).append(message.getType()).toString());
		message.name = attribute.getValue();
		attribute = xMessage.getAttribute("headerLength");
		if (attribute == null)
			throw new ECRException((new StringBuilder("No headerLength   definition  or errorin message's attributes  @message type:")).append(message.getType()).toString());
		try
		{
		...
		if (attribute == null)
			throw new ECRException((new StringBuilder("No id   definition  or error in message's attributes  @message type:")).append(message.getType()).toString());
		...
		{
			throw new ECRException((new StringBuilder()).append(exception.getMessage()).append(" @message type:").append(message.getType()).toString());
		}
		return message;
	}
