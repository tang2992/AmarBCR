...
public class VillageGuaranteeChangeReportUnit extends ExecuteUnit
{

	private static String splitStr = "`";
	private MessageProcessSession session;

	public VillageGuaranteeChangeReportUnit()
	{
		session = null;
	}
	...
	private MessageProcessSession createSession()
		throws BCRException
	{
		String msgs = getProperty("com.amarsoft.app.datax.bcr.session.ReportSession.messageSetType", "16");
