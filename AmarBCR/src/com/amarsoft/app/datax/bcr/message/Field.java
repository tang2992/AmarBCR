	...
	implements Cloneable
{
		...
		throws BCRException
	{
		...
		if (attribute == null)
			throw new BCRException("No id   definition or error in field's attributes ");
		...
		if (attribute == null)
			throw new BCRException("No optional   definition  or errorin field's attributes ");
		...
		if (attribute == null)
			throw new BCRException("No optional   definition or error in field's attributes ");
		try
		{
