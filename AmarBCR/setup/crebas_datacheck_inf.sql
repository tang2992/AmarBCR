...
create table ECR_ALSDATACHECK  (
  ...
  LOANSUM              MONEY(24,6),
  FACTORINGOUTSUM      MONEY(24,6),
  DISCOUNTOUTSUM       MONEY(24,6),
  FINAOUTSUM           MONEY(24,6),
  CREDITLETTEROUTSUM   MONEY(24,6),
  GUARANTEEBILLOUTSUM  MONEY(24,6),
  ACCEPTOUTSUM         MONEY(24,6),
  CUSTOMERCREDITOUTSUM MONEY(24,6),
  ASSURECONTOUTSUM     MONEY(24,6),
  GUARANTYCONTOUTSUM   MONEY(24,6),
  IMPAWNCONTOUTSUM     MONEY(24,6),
  FLOORFUNDOUTSUM      MONEY(24,6),
  LOANBALANCE          MONEY(24,6),
  FACTORINGBALANCE     MONEY(24,6),
  DISCOUNTBALANCE      MONEY(24,6),
  FINABALANCE          MONEY(24,6),
  CREDITLETTERBALANCE  MONEY(24,6),
  GUARANTEEBILLBALANCE MONEY(24,6),
  ACCEPTBALANCE        MONEY(24,6),
  ASSURECONTBALANCE    MONEY(24,6),
  GUARANTYCONTBALANCE  MONEY(24,6),
  IMPAWNCONTBALANCE    MONEY(24,6),
  FLOORFUNDBALANCE     MONEY(24,6),
  INTERESTBALANCE1     MONEY(24,6),
  INTERESTBALANCE2     MONEY(24,6),
  STATUS               VARCHAR(2),
  CORPID               VARCHAR(10),
  OCCURDATE            VARCHAR(10),
  OLDFINANCEID         VARCHAR(59),
  INCREMENTFLAG        VARCHAR(1),
primary key (LOANCARDNO)
      constraint PK_ECR_ALSDATACHEC
);
...
create table ECR_PBC_ACCEPTANCE  (
  ...
  CLASSIFY5            VARCHAR(5),
  CURRENCY             VARCHAR(5),
  BUSINESSSUM          MONEY(24,6),
  BUSINESSSUMTORMB     MONEY(24,6),
  BUSINESSSUMTOUSD     MONEY(24,6),
...
create table ECR_PBC_ASSURECONT  (
  ...
  CURRENCY             VARCHAR(5),
  VOUCHSUM             MONEY(24,6),
  VOUCHSUMTORMB        MONEY(24,6),
  VOUCHSUMTOUSD        MONEY(24,6),
...
create table ECR_PBC_CREDITLETTER  (
  ...
  BALANCE              MONEY(24,6),
  BALANCETORMB         MONEY(24,6),
  BALANCETOUSD         MONEY(24,6),
...
create table ECR_PBC_DISCOUNT  (
  ...
  BILLSUM              MONEY(24,6),
  BILLSUMTORMB         MONEY(24,6),
  BILLSUMTOUSD         MONEY(24,6),
...
create table ECR_TEMP_BC  (
  ...
  ACTUALPUTOUTSUM      MONEY(24,6),
  BALANCE              MONEY(24,6),
  INTERESTBALANCE1     MONEY(24,6),
  INTERESTBALANCE2     MONEY(24,6),
  MANAGEORGID          VARCHAR(40),
primary key (LOANCARDNO, CONTRACTNO)
      constraint PK_ECR_TEMP_BC
);
...
primary key (LOANCARDNO, DUEBILLNO)
      constraint PK_ECR_TEMP_BD
);
...
create table ECR_TEMP_GC  (
  ...
  GUARANTYVALUE        MONEY(24,6),
  GUARANTYTYPE         VARCHAR(2),
  GUARANTYBALANCE      MONEY(24,6),
primary key (LOANCARDNO, GCONTRACTNO)
      constraint PK_ECR_TEMP_GC
);
...
create table ecr_exteriorcheck  (
  ...
  pbcnum               NUMERIC(10),
  loannum              NUMERIC(10),
  pbcbusinesssum       MONEY(24,6),
  loanbusinesssum      MONEY(24,6),
  pbcbalance           MONEY(24,6),
  loanbalance          MONEY(24,6),
  status1              VARCHAR(10),
  status2              VARCHAR(10),
  remark               VARCHAR(200),
primary key (loancardno, occurdate, businesstype)
      constraint PK_ECR_EXTERIORCHE
);
...
create table ecr_interiorcheck  (
  ...
  ecrnum               NUMERIC(10),
  loannum              NUMERIC(10),
  ecrbusinesssum       MONEY(24,6),
  loanbusinesssum      MONEY(24,6),
  ecrbalance           MONEY(24,6),
  loanbalance          MONEY(24,6),
  status1              VARCHAR(10),
  status2              VARCHAR(10),
  remark               VARCHAR(200),
primary key (loancardno, occurdate, businesstype)
      constraint PK_ECR_INTERIORCHE
);
...
create table BANK_FLOORFUND  (
   ...
   BusinessNo           VARCHAR(60),
   Currency             VARCHAR(3),
   FloorSum             NUMERIC(24,6),
   FloorDate            VARCHAR(10),
   FloorBalance         NUMERIC(24,6),
   BalanceOccurDate     VARCHAR(10),
   ReturnMode           VARCHAR(2),
