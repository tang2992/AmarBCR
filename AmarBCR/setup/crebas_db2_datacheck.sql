...
(
   LOANCARDNO varchar(40) PRIMARY KEY NOT NULL,
...
(
   ...
   LOANCARDNO varchar(16) PRIMARY KEY NOT NULL,
   STATUS varchar(1)
)@
...
(
   ...
   CONSTRAINT PK_BANK_IDUE PRIMARY KEY (CUSTOMERID,INTERESTTYPE,CURRENCY,FINANCEID)
)@
